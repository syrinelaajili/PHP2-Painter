<?php
//Affichage php avec fonctions avec paramètres
...
function createSVG()
{
    ...
    return $beginSVG
    .circle(250,200,150,"#FFF2AB")
    .rectangle(10,10,200,80,"#B22222",0.9)
    .polygon("20,50 20,200 150,200","#A040A0",0.7)
    .carre(340,160,80,80,"#80DDFE",0.7)
    .ellipse(530,140,50,90,"#2E8B57")
    .$endSVG;
}
